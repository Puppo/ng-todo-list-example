...
describe("RegisterEffect", () => {
  ...
  describe("register$", () => {
    ...
    it("should return a RegisterSuccessAction from RegisterAction", () => {
      spyOn(service, "register").and.returnValue(of(empty()));

      const action = new fromActions.RegisterAction(email, password);
      const completion = new fromActions.RegisterSuccessAction();
    ...
    it("should return a RegisterFailAction from RegisterAction", () => {
      ...
      const action = new fromActions.RegisterAction(email, password);
      const completion = new fromActions.RegisterFailAction(fatalError);
